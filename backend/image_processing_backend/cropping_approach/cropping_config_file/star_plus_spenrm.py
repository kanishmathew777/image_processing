...
from cropping_approach.constants.star_plus_spenrm_field_names import MEDICAL_PLAN, MEMBER_DETAILS, \
...
def starplus_spenrm_getfieldindex(fieldname):
    try:
...
def starplus_spenrm_config(image_path, output_folder, form_name, page=1):
    form_config = {
