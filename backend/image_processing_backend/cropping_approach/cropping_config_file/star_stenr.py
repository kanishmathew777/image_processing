...
from cropping_approach.constants.star_stenr_field_names import DOCTOR_NAMES, MEDICAL_DOCTORS, MEDICAL_PLAN, MEMBER_NAME, \
...
def starstenr_getfieldindex(fieldname):
    try:
...
def starstenr_config(image_path, output_folder, form_name, page=1):
    form_config = {
